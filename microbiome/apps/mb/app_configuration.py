...
class AppConfiguration(BaseAppConfiguration):
    ...
    lab_clinic_api_setup = {
        ...
        'aliquot_type': [AliquotTypeTuple('Whole Blood', 'WB', '02'),
                         ...
                         AliquotTypeTuple('Breast Milk', 'BM', '20'),
                         AliquotTypeTuple('Breast Milk: Whole', 'BMW', '21'),
                         AliquotTypeTuple('Breast Milk: Fluid', 'BMF', '22'),
                         AliquotTypeTuple('Breast Milk: Pellet', 'BMP', '23'),
    ...
    lab_setup = {'microbiome': {
                 ...
                 'profile_item': [ProfileItemTuple('Viral Load', 'PL', 1.0, 3),
                                  ...
                                  ProfileItemTuple('Breast Milk (Storage)', 'BMW', 2, 3),
