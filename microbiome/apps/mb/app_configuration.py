...
class AppConfiguration(BaseAppConfiguration):
    ...
    consent_type_setup = [
        {'app_label': 'mb_maternal',
         ...
         'start_datetime': study_start_datetime,
         'end_datetime': datetime(2016, 7, 7, 23, 59),
         'version': '1'},
        {'app_label': 'mb_maternal',
         'model_name': 'maternalconsent',
         'start_datetime': datetime(2016, 7, 8),
         'end_datetime': study_end_datetime,
         'version': '2'}
            ...
            aliquot_label or ZplTemplateTuple(
                'aliquot_label', (
                    ('^XA\n' +
                     ...
                     '^FO300,92^A0N,18,20^FD${aliquot_identifier}^FS\n'
                     '^FO300,109^A0N,16,20^FD${panel}^FS\n'
                     '^FO300,125^A0N,19,20^FD${subject_identifier} (${initials})^FS\n'
                     '^FO300,145^A0N,18,20^FDDOB: ${dob} ${gender}^FS\n'
                     '^FO300,165^A0N,18,20^FD${drawn_datetime}^FS\n'
                     '^XZ')), False),
            ZplTemplateTuple(
                'requisition_label', (
                    ('^XA\n' +
