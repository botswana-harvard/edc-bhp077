from edc_constants.constants import (
    ...
    OFF_STUDY, DEATH_VISIT, ON_STUDY, COMPLETED_PROTOCOL_VISIT, NO_FURTHER_DATA_COLLECTION, )
...
VISIT_REASON = [
    ...
    (DEATH_VISIT, 'Death'),
    (NO_FURTHER_DATA_COLLECTION, 'No further data collection (Subject failed enrollment)'),
