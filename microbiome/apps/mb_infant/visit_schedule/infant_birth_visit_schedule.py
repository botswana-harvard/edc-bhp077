...
class InfantBirthVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['2000'] = {
        ...
        'instructions': None,
        'requisitions': (
            RequisitionPanelTuple(10L, u'microbiome_lab', u'infantrequisition',
                                  'DNA PCR', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(20L, u'microbiome_lab', u'infantrequisition',
                                  'Stool storage', 'STORAGE', 'ST', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(30L, u'microbiome_lab', u'infantrequisition',
                                  'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(40L, u'microbiome_lab', u'infantrequisition',
                                  'Rectal swab (Storage)', 'STORAGE', 'RS', REQUIRED, NOT_ADDITIONAL),
            RequisitionPanelTuple(60L, u'microbiome_lab', u'infantrequisition',
                                  'ELISA', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(70L, u'microbiome_lab', u'infantrequisition',
        ...
        'entries': (
            ...
            EntryTuple(200L, u'microbiome_infant', u'infantdeathreport', NOT_REQUIRED, ADDITIONAL),
    ...
    visit_definitions['2010'] = {
        ...
        'entries': (
            ...
            EntryTuple(50L, u'microbiome_infant', u'infantfudx', NOT_REQUIRED, ADDITIONAL),
