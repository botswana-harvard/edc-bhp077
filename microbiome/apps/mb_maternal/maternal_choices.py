...
from microbiome.apps.mb.constants import LIVE, STILL_BIRTH
...
NEXT_CHILD_PLAN = (
    ('within 2years', 'a. Within the next 2 years'),
    ('between 2-5years from now', 'b. From 2 years to 5 years from now'),
    ('More than 5years from now', 'c. More than 5 years from now'),
    ('Dont know right now', 'd. I do not know right now'),
    ('DWTA', 'e. Don\'t want to answer'))
