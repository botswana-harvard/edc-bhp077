 ...
 * @property {String} [buttonLabelHtml = "Capture!"] Specify label HTML of
 *           control button.
...
function SnapShotControl(opt_opts) {
  ...
  this.getImage = function (mapCenterPos) {
    ...
    me.imgUrl_ = url;
    document.location.href ='data:Application/octet-stream,' + encodeURIComponent(url);
    return url;
  };
