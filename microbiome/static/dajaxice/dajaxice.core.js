...
var Dajaxice = {
    ...
    view_result_report: function(callback_function, argv, custom_settings){
        return Dajaxice.call('edc.lab.lab_clinic_api.view_result_report', 'POST', callback_function, argv, custom_settings);
    },

    plot_longitudinal_results: function(callback_function, argv, custom_settings){
        return Dajaxice.call('edc.lab.lab_clinic_api.plot_longitudinal_results', 'POST', callback_function, argv, custom_settings);
    },

    updating: function(callback_function, argv, custom_settings){
        return Dajaxice.call('edc.lab.lab_clinic_api.updating', 'POST', callback_function, argv, custom_settings);
    },

    update_result_status: function(callback_function, argv, custom_settings){
        return Dajaxice.call('edc.lab.lab_clinic_api.update_result_status', 'POST', callback_function, argv, custom_settings);
    }
    ...
    print_label: function(callback_function, argv, custom_settings){
        return Dajaxice.call('edc.lab.lab_requisition.print_label', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    print_result_report: function(callback_function, argv, custom_settings){
        return Dajaxice.call('lis.core.lab_result_report.print_result_report', 'POST', callback_function, argv, custom_settings);
    }
