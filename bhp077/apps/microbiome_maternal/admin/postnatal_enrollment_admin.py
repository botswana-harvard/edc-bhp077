...
class PostnatalEnrollmentAdmin(BaseModelAdmin):
    ...
    def required_fields(self):
        fields = [
            'registered_subject', 'report_datetime', 'postpartum_days', 'delivery_type', 'gestation_before_birth',
            'live_or_still_birth', 'live_infants'
        ]
        return fields
    ...
    def update_postnatal(self, form, antenatal):
        ...
        form.base_fields['is_diabetic'].widget.attrs['disabled'] = 'disabled'
        ...
        for field in ['is_diabetic', 'on_tb_treatment', 'on_hypertension_treatment', 'breastfeed_for_a_year',
