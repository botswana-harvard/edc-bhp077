...
from ..models import MaternalVisit, AntenatalEnrollment, PostnatalEnrollment, SampleConsent
...
class SampleConsentVisitSchedule(VisitScheduleConfiguration):
    ...
    membership_forms = OrderedDict({'sample': MembershipFormTuple(
        'sample', SampleConsent, True), })

    schedule_groups = OrderedDict({
        'Sample Consent': ScheduleGroupTuple('Sample Consent',
                                             'sample', None, None), })
