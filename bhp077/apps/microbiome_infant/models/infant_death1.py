...
class InfantDeath (BaseDeathReport, RequiresConsentMixin, InfantOffStudyMixin, TimePointStatusMixin): # RequiresConsentMixin, InfantOffStudyMixin, TimePointStatusMixin
