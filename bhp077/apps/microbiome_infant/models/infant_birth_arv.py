...
class InfantBirthArv(InfantScheduledVisitModel):
    ...
    nvp_discharge_supply = models.CharField(
        ...
        help_text=("only applicable to breastfed infants of mothers either not on HAART "
                   "or on HAART <6 weeks"))
    ...
    def get_absolute_url(self):
        return reverse('admin:microbiome_infant_infantbirtharv_change', args=(self.id,))
